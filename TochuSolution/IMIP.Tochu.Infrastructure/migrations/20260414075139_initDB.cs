        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackagingCD = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PackagingName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    LotNumber = table.Column<int>(type: "int", nullable: false),
                    PerformanceM = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ForCustomers = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
